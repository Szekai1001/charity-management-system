<table>
    <thead>
        ...
        <tr>
            <th style="font-weight: bold; border: 1px solid #000000; background-color: #dbe5f1; text-align: center; width: 15px;">ID</th>
            <th style="font-weight: bold; border: 1px solid #000000; background-color: #dbe5f1; text-align: left; width: 30px;">Student Name</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            if(strtolower($attendance->status) == 'present') $statusColor = '#c6efce'; // Light Green
            if(strtolower($attendance->status) == 'absent') $statusColor = '#ffc7ce'; // Light Red
            if(strtolower($attendance->status) == 'late') $statusColor = '#ffeb9c'; // Light Yellow
            @endphp
